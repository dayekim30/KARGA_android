...
{	
	...
	public static void main(String[] args) throws Exception
	{
		...
		int k = 17;
		String dbfile="/data/data/com.ops.text1/files/megares_full_database_v2.00.fasta";
		String readfile="/data/data/com.ops.text1/files/";
		
		for (int t=0; t<args.length; t++)
		{
			if (args[t].charAt(0)=='d') dbfile=args[t].split(":")[1];
			if (args[t].endsWith(".fastq") || args[t].endsWith(".gz")) readfile=readfile+args[t];
		...
		FileWriter filewriter = new FileWriter(new File("/storage/self/primary/Download",readfile.substring(index+1,readfile.lastIndexOf("."))+"_ResistomeMapperKARGA.csv"));
